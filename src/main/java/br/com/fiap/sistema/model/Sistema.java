...
@Table(name = "TB_SISTEMA"
        , uniqueConstraints = {
@UniqueConstraint(name = "UK_SISTEMA_SIGLA", columnNames = "SG_SISTEMA"))
        }
...
public class Sistema {
    ...
    @JoinTable(
            ...
            joinColumns = {
                    @JoinColumn(name = "SISTEMA", referencedColumnName = "ID_SISTEMA", foreignKey = @ForeignKey(name = "FK_SISTEMA"))
            },
            inverseJoinColumns = {
                    @JoinColumn(name = "GESTOR", referencedColumnName = "ID_PESSOA", foreignKey = @ForeignKey(name = "FK_GESTOR_SISTEMA"))
            }
    )
